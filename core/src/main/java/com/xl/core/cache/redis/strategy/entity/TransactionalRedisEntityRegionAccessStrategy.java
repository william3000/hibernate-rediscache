...
public class TransactionalRedisEntityRegionAccessStrategy extends RedisAccessStrategy<RedisEntityRegion> implements EntityRegionAccessStrategy {
	...
	public Object get(Object key, long txTimestamp) throws CacheException {
		return this.region().get((String)key);
	}
	...
	public boolean insert(Object key, Object value, Object version) throws CacheException {
		try{
			this.region().put((String)key, value);
			return true;
		}catch(Exception e){
			e.printStackTrace();
			return false;
